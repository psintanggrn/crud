    ...
    <div class="col-md-12">
        ...
        <form method="post" action= "edit_aksi.php" class="form_horizontal">
            ...
            <div class="mb-3">
                ...
                <input class="form-check-input" type="radio" name="jenis_kelamin" value="Laki-Laki" <?php if($mhs['jenis_kelamin']=='Laki-Laki') echo 'checked' ?>>
            ...
            <div class="mb-3">
                <label class="from-label fe-bold">Program Studi</label>
            ...
            <div class="mb3">
            <label class="from-label fe-blod">Keahlian</label>
            <div class="form-check">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="keahlian[]" value= "Enterprise architecture"<?php if(in_array("Enterpise architecture", $checked)) echo "checked" ?>>
                <label class="form-check-label">
